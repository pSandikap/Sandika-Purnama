		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<form action="<?php echo site_url('admin/transaksi/edit') ?>" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group">
								...
								<input type="text" name="old_jatuhtempo" value="<?= $transaksi->jatuh_tempo ?>" hidden>
								<input type="text" name="old_ditetapkan" value="<?= $transaksi->ditetapkan ?>" hidden>
							</div>
							<div class="form-group">
