			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<!-- <a href="<?php echo site_url('super/lokasi/add') ?>"><i class="fas fa-plus"></i> Add New</a>-->
					</div>
					<div class="card-body">
							...
							<table class="table table-hover" id="dataTable2" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<!--<td width="120">
											<a href="<?php echo site_url('super/lokasi/edit/'.$lokasi->id) ?>"
											 class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
											<a onclick="deleteConfirm('<?php echo site_url('super/lokasi/delete/'.$lokasi->id) ?>')"
