...
class lokasi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("admin/lokasi/list", $data);
    }
    ...
    public function add()
    {
        ...
        if ($validation->run()) {
            ...
            if (!$this->upload->do_upload('gambar')) {
                $this->load->view("admin/lokasi/list");
            }else{
        ...
        $this->load->view("admin/lokasi/new_form");
    }

    public function edit($id)
    {

        if (!isset($id)) redirect('admin/lokasi');
        ...
        $this->load->view("admin/lokasi/edit_form", $data);
    }
