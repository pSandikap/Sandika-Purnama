...
class transaksi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("super/transaksi/list", $data);
    }

    public function add_page()
    {
        $data['lokasi'] = $this->Lokasi_model->getAll();
        $this->load->view("super/transaksi/new_form",$data);
    }
    ...
    public function add()
    {
        ...
        if (!$this->upload->do_upload('gambar')) {
            $this->load->view("super/transaksi/new_form");
        }else{
    ...
    public function edit_page($id){
        ...
        $this->load->view("super/transaksi/edit_form", $dataa);
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Transaksi_model->delete($id)) {
            redirect(site_url('super/transaksi'));
        }
    }
}